...
def get_point_cloud(mesh, number_of_points = 500000, surface_point_method='scan', sign_method='normal', scan_count=100, scan_resolution=400, sample_point_count=10000000, normal_sample_count=11, min_size=0, return_gradients=False):
    mesh = scale_to_unit_sphere(mesh)
    ...
    return surface_point_cloud.get_random_surface_points(number_of_points, surface_point_method=="scan")
